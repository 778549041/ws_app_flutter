...
class MineController extends BaseController {
  ...
  void onInit() {
    data.assignAll([
      ...
      {"imageName": "assets/images/mine/mine_normal_question.png", "title": "常见问题"},
      {"imageName": "assets/images/mine/mine_certify_info.png", "title": "认证信息"},
      {"imageName": "assets/images/mine/mine_check_report.png", "title": "检查报告"},
