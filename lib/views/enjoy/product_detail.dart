...
class ProductDetailPage extends GetView<ProductDetailController> {
  ...
  Widget build(BuildContext context) {
    return BasePage(
      title: '商品详情',
      child: Obx(
        () => controller.model.value.dataDetail == null
            ? Container()
            : Column(
                children: <Widget>[
                  Expanded(
                        ...
                        children: <Widget>[
                          Stack(
                            children: <Widget>[
                              ...
                              Positioned(
                                ...
                                top: 0,
                                child: Offstage(
                                  offstage: controller.model.value.dataDetail
                                              ?.typeVip ==
                                          null
                                      ? true
                                      : !controller
                          ...
                          Offstage(
                            offstage: controller
                                    ...
                                    null
                                ? true
                                : controller.model.value.relgoods!.deduction! ==
                                    0,
                            child: Container(
                                  ...
                                  Flexible(
                                    child: Text(
                                      TextUtil.formatComma3(controller.model
                                              ...
                                              null
                                          ? ''
                                          : controller.model.value.relgoods!
                                              .deduction!),
                                      style: TextStyle(
                                          color: Color(0xFFE30052),
                                          fontSize: 15),
                                    ),
                                  ),
                                  Image.asset(
                          ...
                          Container(
                            ...
                            child: Html(
                              data: controller.model.value.dataDetail
                                          ?.description ==
                                      null
                                  ? ''
                                  : controller
                                      .model.value.dataDetail!.description!,
