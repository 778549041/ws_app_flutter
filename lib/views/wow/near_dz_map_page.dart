    ...
    return BasePage(
      titleWidget: Container(
        ...
        child: CustomTextField(
          ...
          inputCallBack: (value) => controller.inputSearch(value),
        ),
      ),
      child: Stack(
        children: <Widget>[
            ...
            child: Offstage(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    // Map map = _searchData[index];
                    // LatLng location = map['location'];
                    return GestureDetector(
                      onTap: () {
                        ...
                        //   _searchData.clear();
                        // });
                        // _controller.setCenterCoordinate(location);
                        // _getCurrentMarkerData(
